let quizQs = [
    ...
    {question: "How do you write you header 1 element?", answers: ["<header1>", "<head1>", "<h0>", "<h1>"]},
...
rotatingQs.textContent = quizQs[0].question;
rotatingAsA.textContent = quizQs[0].answers[0];
rotatingAsB.textContent = quizQs[0].answers[1];
rotatingAsC.textContent = quizQs[0].answers[2];
rotatingAsD.textContent = quizQs[0].answers[3];
